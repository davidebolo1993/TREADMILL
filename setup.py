...
setup(name='TREADMILL',      
  ...
  license='LICENSE.txt',
  install_requires=['pyfaidx>=0.5.5.2', 'pysam>=0.15.0', 'editdistance>=0.5.2', 'numpy>=1.15.3', 'pybedtools>=0.8.0', 'mappy>=2.17', 'pandas>=1.1.2', 'regex>=2.5.97', 'scikit-learn>=0.24.0', 'matplotlib>=3.3.4'],
  zip_safe=False,
